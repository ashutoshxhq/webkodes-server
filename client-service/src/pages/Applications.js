        ...
        <div className="col-xl-9">
            <div className="card">
                <div className="card-body">
                    ...
                    <div>
                        <p>You can deploy your applications (node, go, php, react, angular, vue etc) from here with ease. Click on New Application button to get started.</p>
                    </div>
                </div><img className="card-img-bottom img-fluid" src="assets/images/apps.png" alt="Card cap"/></div>
        </div>
        <div className="col-xl-3">
            <div className="row">
                <div className="col-xl-12">
