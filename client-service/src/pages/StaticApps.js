              ...
              <div className="card-body">
                  <div className="row">
                      <div className="col-xl-9">
                          <h4 className="card-title">Your Static Sites</h4>
                          <p className="card-subtitle mb-4 font-size-13">All the deployed static sites</p>
                      </div>
                      <div className="col-xl-3">
                          <div className="float-right d-none d-md-block"><Link className="btn btn-secondary active waves-effect waves-light" onClick={() => setLoading(true)} to="/addstaticsite"><i className="mdi mdi-hospital mr-2"></i> New Static Site</Link></div>
                      </div>
                  </div>
                  <div className="row">
                      <div className="col-md-3">
                          <div className="card card-body workspace">
                              ...
                              <div className="row mb-2">
                                  <div className="col-xl-12">
                                      <button className="btn btn-secondary active btn-block waves-effect waves-light"><span>Open Site</span> </button>
                                  </div>
                              </div>
                          </div>
                      </div>
      ...
      <div className="col-xl-9">
          <div className="card">
              <div className="card-body">
                  <div className="row">
                      <div className="col-xl-9">
                          <h3 className="card-title font-16 mt-0">Static Sites</h3></div>
                      <div className="col-xl-3">
                          <div className="float-right d-none d-md-block"><Link className="btn btn-secondary active waves-effect waves-light" onClick={() => setLoading(true)} to="/addapplication"><i className="mdi mdi-hospital mr-2"></i> New Static Site</Link></div>
                      </div>
                  </div>
                  <div>
                      <p>You can deploy your static sites buit using gatsby or simple html, css and js from here with ease. Click on New Staic Site button to get started.</p>
                  </div>
              </div><img className="card-img-bottom img-fluid" src="assets/images/static.png" alt="Card cap"/></div>
      </div>
      <div className="col-xl-3">
          <div className="row">
              <div className="col-xl-12">
